...
async def auth_get_profile(authorization: Optional[str] = Header(None)):
    """Return current user's education profile for personalised note generation."""
...
async def auth_update_profile(
    ...
    """Update current user's education profile (class/level, institute, goals, etc.)."""
