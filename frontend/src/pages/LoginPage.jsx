            ...
            <div style={{ width: '100%', maxWidth: 460, background: 'var(--bg)' }}>
                <div style={{ width: '100%', maxWidth: 380, margin: '0 auto' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 28 }}>
                        <div style={{ background: 'var(--surface)', borderRadius: 12, padding: '8px 14px', border: '1px solid var(--border)' }}>
                            <img src="/logo.jpeg" alt="AuraGraph" style={{ height: 'clamp(36px, 6vw, 56px)', width: 'auto', display: 'block' }} />
                        </div>
                    </div>
