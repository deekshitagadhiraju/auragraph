...
export default function NoteRenderer({ content, onDoubtLink, fontSize = 16, darkMode = null }) {
    ...
    const mk = {
        h1({ children }) {
            return (
                <div style={{ marginBottom: 32, paddingBottom: 20, borderBottom: '2px solid #EDE9FE' }}>
                    <div style={{ fontSize: 10, textTransform: 'none', letterSpacing: '0.16em', color: 'var(--ag-purple)', marginBottom: 8, fontFamily: '"DM Sans",sans-serif', fontWeight: 700 }}>AuraGraph · Study Notes</div>
            ...
            if (isExercise) return (
                <div className="nr-keep-together nr-callout" style={{ background: '#EFF6FF', border: '1px solid #BFDBFE', borderLeft: '3px solid #3B82F6', borderRadius: 8, padding: '10px 14px', margin: '14px 0' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 11, fontWeight: 700, color: '#1D4ED8', letterSpacing: '0.05em', textTransform: 'none', fontFamily: '"DM Sans",sans-serif' }}>Exercise</span>
                    </div>
        ...
        blockquote({ children }) {
            ...
            if (isFormula) return (
                <div className="nr-keep-together nr-callout nr-formula-box" style={{ background: isDark ? '#111827' : '#F8FAFC', border: `1px solid ${isDark ? '#334155' : '#E2E8F0'}`, borderLeft: '3px solid var(--ag-purple)', borderRadius: 8, padding: '12px 16px', margin: '16px 0' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}><span style={{ fontSize: 14 }}>🔢</span><span style={{ fontSize: 11, fontWeight: 700, color: isDark ? '#94A3B8' : '#475569', textTransform: 'none' }}>Formula</span></div>
            ...
            if (isIntuition) return (
                <div className="nr-keep-together nr-callout" style={{ background: isDark ? '#1E1B4B' : '#F5F3FF', border: `1px solid ${isDark ? '#4C1D95' : '#EDE9FE'}`, borderLeft: '3px solid var(--ag-purple)', borderRadius: 8, padding: '12px 16px', margin: '16px 0' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}><span style={{ fontSize: 14 }}>💡</span><span style={{ fontSize: 11, fontWeight: 700, color: 'var(--ag-purple)', textTransform: 'none' }}>Intuition</span></div>
        ...
        th({ children }) { return <th style={{ padding: '10px 16px', textAlign: 'left', fontWeight: 700, color: isDark ? '#C4B5FD' : 'var(--ag-purple-deep)', borderBottom: isDark ? '2px solid #6366F1' : '2px solid #C4B5FD', whiteSpace: 'nowrap', fontSize: 12, textTransform: 'none', letterSpacing: '0.05em' }}>{children}</th>; },
