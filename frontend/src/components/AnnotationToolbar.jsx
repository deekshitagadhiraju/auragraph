            ...
            {open && (
                <div style={{
                    ...
                    <div style={{ padding: '6px 6px 4px', borderBottom: '1px solid var(--border)' }}>
                        <div style={{ fontSize: 9, fontWeight: 700, color: 'var(--text3)', textTransform: 'none', letterSpacing: '0.1em', padding: '2px 8px 6px' }}>Tools</div>
                    ...
                    <div style={{ padding: '4px 6px 6px' }}>
                        <div style={{ fontSize: 9, fontWeight: 700, color: 'var(--text3)', textTransform: 'none', letterSpacing: '0.1em', padding: '4px 8px 6px' }}>Storage</div>
