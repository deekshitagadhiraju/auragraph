                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                            ...
                            <div>
                                <div style={{ fontSize: 11, fontWeight: 700, color: badge.color, textTransform: 'none', letterSpacing: '0.1em', marginBottom: 2 }}>
                                    Aura Rank
                                </div>
    ...
    return (
        ...
        {profile && (profile.total_questions > 0 || profile.total_doubts > 0) && (
            <div style={{ marginTop: 16, padding: '12px 14px', background: 'var(--surface)', borderRadius: 10, border: '1px solid var(--border)' }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--text3)', textTransform: 'none', letterSpacing: '0.06em', marginBottom: 10 }}>
                    Learning Profile
                </div>
            ...
            {BADGES.map(b => {
                ...
                return (
                    <div key={b.id} style={{
                        ...
                        <div style={{ fontSize: 28, filter: earned ? 'none' : 'brightness(0.86) saturate(0.92)' }}>{b.emoji}</div>
                        <div style={{ flex: 1 }}>
